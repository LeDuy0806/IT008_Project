...
export const login = (formData, history,handleNotify,setAuthError) => async (dispatch) => {
  try {
...
export const register = (formData, history,handleNotify,setAuthError) => async (dispatch) => {
  try {
