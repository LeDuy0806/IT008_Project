    ...
    <section className={styles.section}>
      <div className={styles["question-list"]}>
        ...
        <div className={styles["question-list-container"]}>
          ...
          >
            {isLanguageEnglish ? "Add question" : "Thêm một câu hỏi"}
          </button>
        </div>
      </div>
      ...
      <div className={styles.options}>
        ...
        >
          ...
          <div className={styles["option-label"]}>
            <label>
              {isLanguageEnglish ? "Points per question" : "Điểm cho câu hỏi"}
            </label>
          </div>
          <input
            type="number"
          ...
          />
          <div className={styles["option-label"]}>
            <label>{isLanguageEnglish ? "Access" : "Quiz sẵn có"}</label>
          </div>
          <div>
            <button
              onClick={() => {
          ...
          <div>
            ...
            >
              {isLanguageEnglish ? "Submit" : "Hoàn thành việc tạo ra bài kiểm tra"}
            </button>
          </div>
        </div>
        <div
        ...
        >
            ...
            >
              <option defaultValue disabled>
                {isLanguageEnglish
                  ...
                  : "Chọn một loại câu hỏi"}
              </option>
              <option value="Quiz">Quiz</option>
              <option value="True/False">
                {isLanguageEnglish ? "True/False" : "Sự thật sai"}
              </option>
            </select>
          </div>
          <div className={styles.option}>
            <div className={styles["option-label"]}>
              <img src={timer} alt="" />
              <label>{isLanguageEnglish ? "Time limit" : "Thời gian giới hạn"}</label>
            </div>
            <select
              onChange={handleQuestionChange}
              name="answerTime"
          ...
          <div className={styles.option}>
            ...
            >
              <option defaultValue disabled>
                {isLanguageEnglish
                  ? "Set points type"
                  : "Chọn cách giải thưởng điểm"}
              </option>
              <option value="Standard">Standard</option>
              <option value="Double">
                {isLanguageEnglish ? "Double" : "Số lượng gấp đôi"}
              </option>
          ...
          <div className={styles.option}>
            <div className={styles["option-label"]}>
              ...
              <label>
                {isLanguageEnglish ? "Answer options" : "Tùy chọn câu trả lời"}
              </label>
            </div>
            <select onChange={changeMaxCorrectAnswerCount}>
              ...
              <option value="1">
                {isLanguageEnglish ? "Single choice" : "Lựa chọn đơn lẻ"}
              </option>
              <option value="4">
          ...
          <div>
            ...
            <button
              ...
              className={styles["option-button"]}
            >
              {isLanguageEnglish ? "Delete" : "Loại bỏ"}
            </button>
          </div>
        </div>
      </div>
