...
export default function Noresult(){
    return (
        <div className={styles["container"]}>
            <img style={{width:"200px"}} src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg//assets/a60759ad1dabe909c46a817ecbf71878.png" class="shopee-search-empty-result-section__icon" alt="    "></img>
